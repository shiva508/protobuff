...
// source: date_imp.proto

public final class DateImp {
  private DateImp() {}
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return DateImp.internal_static_Date_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return DateImp.internal_static_Date_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              DateImp.Date.class, DateImp.Date.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof DateImp.Date)) {
        return super.equals(obj);
      }
      DateImp.Date other = (DateImp.Date) obj;
    ...
    public static DateImp.Date parseFrom(
    ...
    public static DateImp.Date parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static DateImp.Date parseFrom(
    ...
    public static DateImp.Date parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static DateImp.Date parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static DateImp.Date parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(DateImp.Date prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using DateImp.Date.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public DateImp.Date getDefaultInstanceForType() {
        return DateImp.Date.getDefaultInstance();
      }

      @java.lang.Override
      public DateImp.Date build() {
        DateImp.Date result = buildPartial();
      ...
      @java.lang.Override
      public DateImp.Date buildPartial() {
        DateImp.Date result = new DateImp.Date(this);
        result.year_ = year_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof DateImp.Date) {
          return mergeFrom((DateImp.Date)other);
        } else {
      ...
      public Builder mergeFrom(DateImp.Date other) {
        if (other == DateImp.Date.getDefaultInstance()) return this;
        if (other.getYear() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        DateImp.Date parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (DateImp.Date) e.getUnfinishedMessage();
    ...
    private static final DateImp.Date DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new DateImp.Date();
    }

    public static DateImp.Date getDefaultInstance() {
